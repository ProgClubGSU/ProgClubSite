...
const RetroButton = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, RetroButtonProps>(
  ({ className, variant, children, href, external, ...props }, ref) => {
    const classes = cn(retroButtonVariants({ variant, className }))
