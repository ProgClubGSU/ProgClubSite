...
We've created templates on Google Docs and LaTeX with notes to guide you and jumpstart your resume:
...
<ButtonGroup alignment="center" spacing="md" client:load>
  ...
  <Button
    ...
    icon=""
    size="sm"
    href="https://www.overleaf.com/read/hkwggdfzrdjf#f0af7d"
    external={true}
    client:load
  >
    LaTeX (Advanced)
