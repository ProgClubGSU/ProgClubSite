...
## Practice on ProgSu Showdown

1v1 competitive coding with all 91+ problems, built-in video solutions, and a leaderboard to track your progress:
...
<ButtonGroup alignment="center" spacing="md" client:load>
  ...
  <Button
    ...
    icon=""
    size="sm"
    href="https://showdown-nu.vercel.app"
    external={true}
    client:load
  >
    1v1 Arena
...
Use [ProgSu Showdown](https://showdown-nu.vercel.app/practice) to track which problems you've completed and compete with others.
