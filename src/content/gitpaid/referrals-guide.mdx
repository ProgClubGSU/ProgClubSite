...
<div style={{backgroundColor: 'black', padding: '1.5rem', borderRadius: '0.5rem', margin: '1.5rem 0'}}>
...
- Add a Calendly question for phone/best contact method. Keep it clean and transparent:
  > "What's the best number to text if anything changes before the call?"
- If you texted them before the call, own it:
  > "Sorry I texted you without asking beforehand. Just wanted to make sure we could meet."
...
- If they agree to refer but apps aren't open yet, build a yes ladder:
  > "Awesome, thank you. Can I text the number you put in Calendly when apps open so you see it right away?"
- This works because they already gave you the number, you already texted once to make sure the call happened, and they already said yes to the referral. The next ask feels small.
...
- Your contact info (email + phone + LinkedIn) + ask what the best way to reach them is
