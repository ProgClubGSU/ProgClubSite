...
export const ABOUT_ME = "progsu is a student-run organization at Georgia State University in <strong>Atlanta</strong>, dedicated to <strong>coding</strong>, <strong>learning</strong>, and building a supportive tech community. We host workshops, hackathons, and social events for all skill levels!";
