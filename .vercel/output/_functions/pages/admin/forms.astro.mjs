/* empty css                                    */
import { c as createAstro, a as createComponent, f as renderComponent, b as renderTemplate, m as maybeRenderHead, d as addAttribute } from '../../chunks/astro/server_DQwDjssB.mjs';
import 'kleur/colors';
...
const $$Forms = createComponent(($$result, $$props, $$slots) => {
  ...
  const FORM_REGISTRY = [
    ...
    },
    {
      ...
      formId: "your-leetcode-form-id",
      url: "/events/attendance?type=leetcode-workshop",
      status: "active"
    },
    {
      id: "react-attendance",
      ...
      formId: "your-react-form-id",
      url: "/events/attendance?type=react-workshop",
      status: "draft"
    },
    {
      id: "workshop-feedback",
      name: "Workshop Feedback",
      description: "Post-workshop feedback collection",
      formId: "your-workshop-feedback-id",
      url: "/forms/feedback?event=workshop",
      status: "active"
    },
    {
      id: "general-feedback",
      name: "General Feedback",
      description: "General club feedback and suggestions",
      formId: "your-general-feedback-id",
      url: "/forms/feedback?event=general",
      status: "active"
    }
  ];
