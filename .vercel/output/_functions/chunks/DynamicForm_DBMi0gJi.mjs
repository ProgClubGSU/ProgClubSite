import { c as createAstro, a as createComponent, m as maybeRenderHead, r as renderScript, b as renderTemplate, d as addAttribute } from './astro/server_DQwDjssB.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                              */
...
const $$DynamicForm = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let formError = null;
  try {
    const apiUrl = false ? `http://localhost:4321/api/forms/get-structure?formId=${formId}` : `/api/forms/get-structure?formId=${formId}`;
